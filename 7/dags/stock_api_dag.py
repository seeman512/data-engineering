...
stock_api_config = cfg.stock_api()
fs_config = cfg.fs()
connections_config = cfg.connections()

username = Variable.get("app_username", stock_api_config["username"])
password = Variable.get("app_password", stock_api_config["password"])
...
to_bronze_task = StockApiToHdfsOperator(
    ...
    http_conn_id=connections_config["stock_api_connection_id"],
    endpoint=stock_api_config["endpoint"],
    auth_endpoint=stock_api_config["auth_endpoint"],
    date=yesterday,
